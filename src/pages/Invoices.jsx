...
export function buildInvoiceHTML(invoice, client, settings) {
  ...
  // Bank details are only shown on the live invoice payment panel, never in the
  // downloaded PDF. Once an invoice is paid, banking info is sensitive and
  // redundant; before payment, clients see it in the Bank Transfer flow.
