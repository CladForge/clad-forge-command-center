                ...
                <div className="settings__codes">
                  ...
                  <div className="settings__codes-grid">
                    {[
                      ...
                      ['{{invoice_number}}', 'Invoice number (e.g., INV-2026-0001-1)'],
                      ['{{invoice_link}}', 'Public link to view the invoice'],
                      ...
                      <div key={code} className={`settings__code ${copiedCode === code ? 'settings__code--copied' : ''}`} onClick={() => copyCode(code)} title="Click to copy">
                        <code>{code}</code>
