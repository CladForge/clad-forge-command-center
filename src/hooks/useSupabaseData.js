...
const TABLE_COLUMNS = {
  ...
  sows: ['id','client_id','project_id','project_title','proposal_number','description','scope_items','deliverables','packages','timeline','budget','terms','notes','valid_until','status','sent_date','accepted_date','share_token','client_signature','client_signed_date','client_notes','client_selections','signed_snapshot','created_at','created_by'],
