...
const TABLE_COLUMNS = {
  ...
  invoices: ['id','invoice_number','client_id','client_name','client_company','client_email','contact_person','project_id','project_title','items','tax_rate','discount','status','issue_date','due_date','sent_date','paid_date','paid_amount','payment_terms','notes','created_at','created_by'],
