      ...
      <div className={`app__main ${sidebarCollapsed ? 'app__main--expanded' : ''}`}>
        ...
        <main className="app__content">
          <Routes>
            ...
            <Route path="/finances" element={<Finances clients={clients} projects={projects} invoices={invoices} recurringExpenses={recurringExpenses} applications={applications} settings={settings} entries={financeEntries} setEntries={setFinanceEntries} taxPayments={taxPayments} setTaxPayments={setTaxPayments} />} />
